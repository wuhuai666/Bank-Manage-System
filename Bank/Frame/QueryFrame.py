from tkinter import *
from  Bank.Function.QueryMoney import *
class QueryFrame(Frame):  # 继承Frame类
    ...
    def createPage(self):
        ...
        Button(self, text='查询余额', font=('华文行楷', 15),command=self.QueryMoney).grid(row=6, column=1, stick=E, pady=10)
    ...
    def QueryMoney(self):
        ...
        query = Querymoney(Idnumber, password)
        count1=query.query(self.count)
        if count1==0:
            self.count=3
        else:
            self.count=count1
